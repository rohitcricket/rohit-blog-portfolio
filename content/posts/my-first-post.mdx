...
re:invent 2019, I hadn't heard of it either. 
...
- How Amazon's engineer implement principles such as shuffle sharding to build resilient 
...
### Messaging is hard!
Messaging sounds simple. Just send some info from one network to another. However, sending messages is where 
everything starts getting difficult. 